...
class Ui_MainWindow(object):
    ...
    def button_clicked2(self):
        ...
        ws.append(["File Name", "Category 1 Name", "Category 2 Name", "Predicted Value" "TP", "TN", "FP", "FN", "TPR",
                 "FPR","TNR","FNR", "F1-Score", "ROC"])
        ...
        prediction = model.predict([prepare('C:/Users/Abbad/Desktop/Sommer22/Project/Test Folder Data/cat.jpeg')])
        ...
        try:
            ...
            for file in os.listdir(directory):
                ...
                Preditcted_Value = CATEGORIES[int(prediction[0][0])]

                ws.append([filename, CATEGORIES[0], CATEGORIES[1], Preditcted_Value])
